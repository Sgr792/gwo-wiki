...
Use this route for detailed meshes and deformation. Rigid weapon parts can have full weight to one bone; fingers and arms need appropriate deforming weights.
...
If needed, download the [Blender 3.3 arm template](/downloads/gwo_arms_template_blender33.blend).
...
- Check wrist, elbow, and finger deformation; do not bind the entire hand to the weapon-body bone.
- Rotate bones individually in Pose Mode and inspect affected meshes.

**Checkpoint:** The magazine bone moves only its intended parts; arms deform naturally and anchors follow.
